...
```{r}
ggplot(data = dt_total_confirmed_cases, aes(x= total_confirmed, y = province)) +
  geom_point()
```
```{r}
ggplot(data = dt_TimeProvince, aes(x = date, y =confirmed, color = province )) + 
  geom_line()
```
<br/>
